...
class DataCompletenessChecker:
    ...
    def _get_latest_trade_date(self, market: str = "CN") -> str | None:
        ...
        try:
            if market == "CN":
                # A股：优先使用 Tushare 查找最新交易日（tushare 模块已移除时优雅降级）
                ...
                try:
                    ...
                    self.logger.warning("⚠️ Tushare 模块不可用，使用默认方法获取交易日")
                    _tushare_available = False
