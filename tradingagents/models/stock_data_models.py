...
class StockDailyQuote(BaseStockModel):
    ...
    dv_ratio: float | None = Field(None, description="股息率")
    dv_ttm: float | None = Field(None, description="滚动股息率")
    total_mv: float | None = Field(None, description="总市值")
    circ_mv: float | None = Field(None, description="流通市值")
...
class BalanceSheetData(BaseModel):
    ...
    total_cur_assets: float | None = Field(None, description="流动资产合计")
    total_nca: float | None = Field(None, description="非流动资产合计")
    total_cur_liab: float | None = Field(None, description="流动负债合计")
    total_ncl: float | None = Field(None, description="非流动负债合计")
    cash_and_equivalents: float | None = Field(None, description="货币资金")
...
class IncomeStatementData(BaseModel):
    ...
    oper_profit: float | None = Field(None, description="营业利润")
    total_profit: float | None = Field(None, description="利润总额")
    n_income: float | None = Field(None, description="净利润")
    n_income_attr_p: float | None = Field(None, description="归母净利润")
    basic_eps: float | None = Field(None, description="基本每股收益")
...
class CashflowStatementData(BaseModel):
    ...
    c_cash_equ_end_period: float | None = Field(None, description="期末现金及现金等价物余额")
    c_cash_equ_beg_period: float | None = Field(None, description="期初现金及现金等价物余额")
...
class FinancialIndicators(BaseModel):
    ...
    net_margin: float | None = Field(None, description="净利率")
...
class StockFinancialData(BaseStockModel):
    ...
    f_ann_date: date | None = Field(None, description="实际公告日期")
    balance_sheet: BalanceSheetData | None = Field(None, description="资产负债表数据")
    income_statement: IncomeStatementData | None = Field(None, description="利润表数据")
    cashflow_statement: CashflowStatementData | None = Field(None, description="现金流量表数据")
    financial_indicators: FinancialIndicators | None = Field(None, description="财务指标")
...
class StockNews(BaseStockModel):
    ...
    sentiment: SentimentType | None = Field(None, description="情绪分析")
    sentiment_score: float | None = Field(None, description="情绪得分", ge=-1, le=1)
...
class MovingAverages(BaseModel):
    ...
    ma60: float | None = Field(None, description="60日均线")
...
class TechnicalIndicatorsData(BaseModel):
    ...
    macd_hist: float | None = Field(None, description="MACD柱状图")
    kdj_k: float | None = Field(None, description="KDJ-K值")
    kdj_d: float | None = Field(None, description="KDJ-D值")
    kdj_j: float | None = Field(None, description="KDJ-J值")
    boll_upper: float | None = Field(None, description="布林带上轨")
    boll_mid: float | None = Field(None, description="布林带中轨")
    boll_lower: float | None = Field(None, description="布林带下轨")
    cci: float | None = Field(None, description="CCI顺势指标")
    williams_r: float | None = Field(None, description="威廉指标")
    bias: float | None = Field(None, description="乖离率")
    roc: float | None = Field(None, description="变动率指标")
    emt: float | None = Field(None, description="简易波动指标")
...
class StockTechnicalIndicators(BaseStockModel):
    ...
    ma: MovingAverages | None = Field(None, description="移动平均线")
    indicators: TechnicalIndicatorsData | None = Field(None, description="技术指标")
