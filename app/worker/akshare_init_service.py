...
class AKShareInitService:
    ...
    async def run_full_initialization(
        ...
        self.stats = AKShareInitializationStats(started_at=datetime.utcnow(), total_steps=total_steps)
...
async def run_akshare_full_initialization(historical_days: int = 365, skip_if_exists: bool = True):
