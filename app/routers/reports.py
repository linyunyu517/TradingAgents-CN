...
def _build_report_query(report_id: str) -> dict[str, Any]:
    ...
    try:
        ...
        logger.warning("ObjectId 转换失败，跳过该过滤条件", exc_info=True)
    return {"$or": ors}
    ...
    try:
        ...
        if format == "docx":
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Word 文档生成失败: {e!s}")
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"PDF 文档生成失败: {e!s}")
