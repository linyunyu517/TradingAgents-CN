...
class NewsDataService:
    ...
    async def save_news_data(
        self, news_data: dict[str, Any] | list[dict[str, Any]], data_source: str, market: str = "CN",
    ) -> int:
        """
        保存新闻数据
    ...
    async def get_latest_news(
        self, symbol: str | None = None, limit: int = 10, hours_back: int = 24,
    ) -> list[dict[str, Any]]:
        """
        获取最新新闻
    ...
    async def search_news(self, query_text: str, symbol: str | None = None, limit: int = 20) -> list[dict[str, Any]]:
        """
        全文搜索新闻
