...
class RedisSessionManager:
    ...
    def load_analysis_state(self) -> dict[str, Any] | None:
        """加载分析状态"""
        try:
            session_key = self._get_session_key()
    ...
    def _load_from_file(self, session_key: str) -> dict[str, Any] | None:
        """从文件加载（fallback方案）"""
        try:
            filename = f"./data/{session_key.replace(':', '_')}.json"
    ...
    def get_debug_info(self) -> dict[str, Any]:
        ...
        try:
            ...
            debug_info = {
                ...
                "session_state_keys": [k for k in st.session_state if "analysis" in k.lower()],
            }
