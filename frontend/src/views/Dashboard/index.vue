          ...
          <div v-if="paperAccount" class="paper-account-info">
            ...
            <div class="account-section">
              ...
              <div class="account-item">
                ...
                <div class="account-value">¥{{ formatMoney(getCashCNY(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">持仓市值</div>
                <div class="account-value">¥{{ formatMoney(getPosValCNY(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">总资产</div>
                <div class="account-value primary">¥{{ formatMoney(getEquityCNY(paperAccount)) }}</div>
              </div>
            </div>

            <!-- 港股账户 -->
            <div class="account-section" v-if="getCashHKD(paperAccount) > 0">
              <div class="account-section-title">🇭🇰 港股账户</div>
              <div class="account-item">
                <div class="account-label">现金</div>
                <div class="account-value">HK${{ formatMoney(getCashHKD(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">持仓市值</div>
                <div class="account-value">HK${{ formatMoney(getPosValHKD(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">总资产</div>
                <div class="account-value primary">HK${{ formatMoney(getEquityHKD(paperAccount)) }}</div>
              </div>
            </div>

            <!-- 美股账户 -->
            <div class="account-section" v-if="getCashUSD(paperAccount) > 0">
              <div class="account-section-title">🇺🇸 美股账户</div>
              <div class="account-item">
                <div class="account-label">现金</div>
                <div class="account-value">${{ formatMoney(getCashUSD(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">持仓市值</div>
                <div class="account-value">${{ formatMoney(getPosValUSD(paperAccount)) }}</div>
              </div>
              <div class="account-item">
                <div class="account-label">总资产</div>
                <div class="account-value primary">${{ formatMoney(getEquityUSD(paperAccount)) }}</div>
              </div>
            </div>
          </div>
