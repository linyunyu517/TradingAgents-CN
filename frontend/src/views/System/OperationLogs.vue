    ...
    <el-card class="logs-table" shadow="never" style="margin-top: 24px">
      ...
      >
        ...
        <el-table-column prop="action_type" label="操作类型" width="120">
          <template #default="{ row }">
            <el-tag :type="getActionTypeTag(row.action_type) as any" size="small">
      ...
      <div v-if="selectedLog" class="log-details">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="操作类型">
            <el-tag :type="getActionTypeTag(selectedLog.action_type) as any">
...
// 方法
const getActionTypeTag = (actionType: string): any => {
