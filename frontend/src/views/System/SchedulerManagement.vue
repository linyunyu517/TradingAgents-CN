...
import { getJobs, getJobDetail, pauseJob, resumeJob, triggerJob, updateJobMetadata, getSchedulerStats, getJobExecutions, getSingleJobExecutions, cancelExecution, markExecutionFailed, deleteExecution, type Job, type JobExecution, type SchedulerStats } from '@/api/scheduler'
...
const activeHistoryTab = ref<string>('manual')
...
const handleHistoryTabChange = (tabName: any) => {
