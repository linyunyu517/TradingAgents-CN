        ...
        <el-card class="connection-card" shadow="never">
          ...
          <div class="connection-status">
            ...
            <div class="connection-actions">
              ...
              <el-button @click="loadDatabaseStatus" :loading="loading" :icon="Refresh as any">
                刷新状态
              </el-button>
            </div>
          </div>
