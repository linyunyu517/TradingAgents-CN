...
def show_analysis_workflow():
    ...
    workflow_steps = [
        ...
        {
            "step": "2. 收集基础信息",
            "details": ["查看最新股价和成交量", "了解最近的重要新闻和公告", "检查财报发布时间和业绩预期"],
        },
        {"step": "3. 运行AI分析", "details": ["选择合适的分析程序", "配置分析参数", "等待AI生成分析报告"]},
        {"step": "4. 验证和补充", "details": ["对比其他分析师观点", "查证关键数据和事实", "补充最新市场信息"]},
        {"step": "5. 制定投资策略", "details": ["确定买入/卖出时机", "设置目标价位和止损点", "规划仓位管理策略"]},
        {"step": "6. 执行和监控", "details": ["按计划执行交易", "定期监控投资表现", "根据市场变化调整策略"]},
    ]
...
def main():
    ...
    logger.info("💡 建议从简单示例开始: python examples/dashscope/demo_dashscope_simple.py")
