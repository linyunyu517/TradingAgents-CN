...
def test_ttm_calculation():
    ...
    print("输入数据:")
    print("  2025Q2: 600万（2025年1-6月累计）")
    print("  2024年报: 1100万（2024年1-12月累计）")
    print("  2024Q2: 500万（2024年1-6月累计）")
    print("\n计算过程:")
    print("  TTM = 2024年报 + (2025Q2 - 2024Q2)")
    print("      = 1100 + (600 - 500)")
    print("      = 1100 + 100")
    print("      = 1200万")
    print(f"\n实际计算结果: {ttm:.2f}万")
    ...
    print(
        f"  TTM = {q3_2024:.2f} + {q4_2024:.2f} + {q1_2025:.2f} + {q2_2025:.2f} = {q3_2024 + q4_2024 + q1_2025 + q2_2025:.2f}万",
    )
    ...
    print("输入数据:")
    print("  2025年报: 1300万（2025年1-12月累计）")
    print("\n计算过程:")
    print("  最新期是年报，直接使用")
    print("  TTM = 1300万")
    print(f"\n实际计算结果: {ttm:.2f}万")
    ...
    print("  2025Q1: 300万")
    print("  2024Q1: 250万")
    print("  ❌ 缺少 2024年报（需要在 2024Q1 之后的年报）")
    print("  2023年报: 1000万（在 2024Q1 之前，不能用）")
    print("\n计算过程:")
    print("  无法计算 TTM，因为缺少基准年报")
    print(f"\n实际计算结果: {ttm}")
    print("预期结果: None")
    print(f"测试结果: {'✅ 通过' if ttm is None else '❌ 失败'}")
    ...
    print("输入数据:")
    print("  2025Q3: 900万（2025年1-9月累计）")
    print("  2024年报: 1100万（2024年1-12月累计）")
    print("  2024Q3: 800万（2024年1-9月累计）")
    print("\n计算过程:")
    ...
    print(
        f"  TTM = {q4_2024:.2f} + {q1_2025:.2f} + {q2_2025:.2f} + {q3_2025:.2f} = {q4_2024 + q1_2025 + q2_2025 + q3_2025:.2f}万",
    )
