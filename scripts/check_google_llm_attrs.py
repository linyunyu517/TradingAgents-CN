...
# 创建实例
llm = ChatGoogleOpenAI(model="gemini-2.5-flash", temperature=0.7, max_tokens=4000)
...
# 检查常见的模型名称属性
attrs_to_check = ["model", "model_name", "model_id", "_model", "__class__.__name__"]
...
for _i, attr in enumerate(all_attrs[:20]):
    try:
