...
async def create_default_users(db):
    ...
    admin_user = {
        ...
        "created_at": now_tz(),
        "updated_at": now_tz(),
        "settings": {"default_research_depth": 2, "enable_notifications": True, "theme": "light"},
    }
    ...
    models = [
        {
            ...
            "pricing": {"input_price_per_1k": 0.001, "output_price_per_1k": 0.002, "currency": "CNY"},
            "limits": {"max_tokens": 4096, "rate_limit_per_minute": 60},
            "created_at": now_tz(),
            "updated_at": now_tz(),
        },
        {
            ...
            "priority": 2,
            "capabilities": ["chat", "analysis", "reasoning"],
            "pricing": {"input_price_per_1k": 0.02, "output_price_per_1k": 0.06, "currency": "CNY"},
            "limits": {"max_tokens": 8192, "rate_limit_per_minute": 60},
            "created_at": now_tz(),
            "updated_at": now_tz(),
        },
        {
            ...
            "pricing": {"input_price_per_1k": 0.03, "output_price_per_1k": 0.06, "currency": "USD"},
            "limits": {"max_tokens": 8192, "rate_limit_per_minute": 60},
            "created_at": now_tz(),
            "updated_at": now_tz(),
        },
