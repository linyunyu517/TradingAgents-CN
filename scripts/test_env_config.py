...
def test_env_variables():
    ...
    # 定义需要检查的环境变量
    env_vars = {
        "AI302_API_KEY": {"name": "302.AI", "required": False, "description": "302.AI 聚合平台 API Key"},
        "OPENROUTER_API_KEY": {"name": "OpenRouter", "required": False, "description": "OpenRouter 聚合平台 API Key"},
        "ONEAPI_API_KEY": {"name": "One API", "required": False, "description": "One API 自部署实例 API Key"},
        "ONEAPI_BASE_URL": {
            "name": "One API Base URL",
            "required": False,
            "description": "One API 自部署实例 Base URL",
        },
        "NEWAPI_API_KEY": {"name": "New API", "required": False, "description": "New API 自部署实例 API Key"},
        "NEWAPI_BASE_URL": {
