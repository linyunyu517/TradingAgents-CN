...
async def test_database_connections():
    ...
    try:
        from webapi.core.database import close_database, get_database_health, init_database
...
async def test_analysis_service():
    ...
    try:
        from webapi.core.database import close_database, init_database
        from webapi.core.redis_client import close_redis, init_redis
        from webapi.models.analysis import AnalysisParameters, SingleAnalysisRequest
        ...
        request = SingleAnalysisRequest(
            stock_code="TEST001",
            parameters=AnalysisParameters(research_depth="快速", selected_analysts=["基本面分析师"]),
        )
