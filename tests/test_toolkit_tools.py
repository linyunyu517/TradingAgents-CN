    ...
    try:
        ...
        if hasattr(toolkit, "get_google_news"):
            ...
            try:
                # 测试调用
                print("📰 测试Google新闻获取...")
                news = toolkit.get_google_news(query="Apple AAPL", curr_date="2025-06-27", look_back_days=3)
...
def check_data_requirements():
    ...
    # 检查Reddit数据目录
    reddit_data_paths = ["tradingagents/dataflows/data_cache/reddit_data", "data/reddit_data", "reddit_data"]
