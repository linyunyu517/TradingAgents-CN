...
def test_gemini_25_pro_basic():
    ...
    try:
        ...
        llm = ChatGoogleGenerativeAI(
            model="gemini-2.5-pro", temperature=0.1, max_tokens=1500, google_api_key=google_api_key,
        )
...
def test_gemini_25_pro_complex_reasoning():
    ...
    try:
        ...
        # 创建实例
        llm = ChatGoogleGenerativeAI(
            model="gemini-2.5-pro", temperature=0.1, max_tokens=2000, google_api_key=os.getenv("GOOGLE_API_KEY"),
        )
