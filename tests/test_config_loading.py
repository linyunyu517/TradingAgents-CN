...
def test_cost_calculation():
    ...
    try:
        ...
        deepseek_cost = config_manager.calculate_cost(
            provider="deepseek", model_name="deepseek-chat", input_tokens=1000, output_tokens=500,
        )
        ...
        dashscope_cost1 = config_manager.calculate_cost(
            provider="dashscope", model_name="qwen-plus", input_tokens=1000, output_tokens=500,
        )
