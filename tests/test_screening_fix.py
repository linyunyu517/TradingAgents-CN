...
def test_screening_api():
    ...
    try:
        ...
        screening_response = requests.post(
            f"{base_url}/api/screening/run", json=screening_request, headers=headers, timeout=30,
        )
        ...
        complex_response = requests.post(
            f"{base_url}/api/screening/run", json=complex_request, headers=headers, timeout=30,
        )
