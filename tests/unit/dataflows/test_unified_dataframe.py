...
# Module not implemented yet — protect import to avoid CollectionError
try:
...
pytestmark = pytest.mark.skipif(
    not _MODULE_AVAILABLE, reason="tradingagents.dataflows.unified_dataframe module not implemented",
)
...
def test_unified_dataframe_prefers_tushare_then_akshare_then_baostock():
    ...
    with (
        mock.patch("tradingagents.dataflows.unified_dataframe.get_tushare_adapter") as m_ts,
