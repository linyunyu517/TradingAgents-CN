...
def test_dashscope_token_tracking():
    ...
    try:
        ...
        llm = ChatDashScope(model="qwen-turbo", api_key=api_key, temperature=0.7, max_tokens=500)
        ...
        # 测试消息
        test_messages = [HumanMessage(content="请简单介绍一下股票投资的基本概念，不超过100字。")]
        ...
        response = llm.invoke(test_messages, session_id=session_id, analysis_type="test_analysis")
