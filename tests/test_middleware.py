    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            if response.status_code == 200:
                ...
                logs_response = await client.get(f"{base_url}/api/system/logs/list", headers=headers)
                ...
                # 测试3: 登出请求
                print("\n🚪 测试3: 登出请求")
                logout_response = await client.post(f"{base_url}/api/auth/logout", headers=headers)
