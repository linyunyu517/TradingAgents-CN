...
def test_get_data_in_range():
    ...
    result = get_data_in_range(
        ticker="NONEXISTENT", start_date="2025-01-01", end_date="2025-01-02", data_type="news_data", data_dir=data_dir,
    )
...
def test_get_finnhub_news():
    ...
    # 测试不存在的股票代码
    result = get_finnhub_news(ticker="NONEXISTENT", curr_date="2025-01-02", look_back_days=7)
...
def create_sample_data_structure():
    ...
    try:
        ...
        sample_data = {"2025-01-01": [{"headline": "Apple发布新产品", "summary": "苹果公司今日发布了新的产品线..."}]}
